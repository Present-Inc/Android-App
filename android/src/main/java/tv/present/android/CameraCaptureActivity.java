...
import tv.present.android.mediacore.AspectFrameLayout;
import tv.present.android.mediacore.CameraHandler;
...
public class CameraCaptureActivity extends Activity implements SurfaceTexture.OnFrameAvailableListener, OnItemSelectedListener {
    ...
    private static final String TAG = "tv.present.android.CameraCaptureActivity";
    ...
    private void openCamera(int desiredWidth, int desiredHeight) {
        ...
        mCamera.setDisplayOrientation(CameraCaptureActivity.ORIENTATION_90);
