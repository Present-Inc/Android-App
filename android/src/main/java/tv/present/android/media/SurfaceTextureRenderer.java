...
/**
 * Class for rendering a texture onto a surface using OpenGL ES 2.0.
 */
public class SurfaceTextureRenderer {

    private static final String TAG = "tv.present.android.mediaextractor.SurfaceTextureRenderer";
    ...
    private int loadShader(int shaderType, String source) {
        ...
        if (compiled[0] == 0) {
            PLog.logError(TAG, "Could not compile shader " + shaderType + ":");
            PLog.logError(TAG, " " + GLES20.glGetShaderInfoLog(shader));
    ...
    private int createProgram(String vertexSource, String fragmentSource) {
        ...
        if (linkStatus[0] != GLES20.GL_TRUE) {
            PLog.logError(TAG, "Could not link program: ");
            PLog.logError(TAG, GLES20.glGetProgramInfoLog(program));
    ...
    public void checkGlError(String op) {
        ...
        while ((error = GLES20.glGetError()) != GLES20.GL_NO_ERROR) {
            PLog.logError(TAG, op + ": glError " + error);
