...
public class CodecInputSurface {
    ...
    /**
     * Creates a CodecInputSurface from a regular Surface.
     * @param surface the "regular" Surface
     */
    public CodecInputSurface(Surface surface) {
        if (surface == null) {
            throw new NullPointerException("The Surface parameter is null!");
        }
    ...
    public void setPresentationTime(long nanoSecs) {
        EGLExt.eglPresentationTimeANDROID(this.mEGLDisplay, this.mEGLSurface, nanoSecs);
